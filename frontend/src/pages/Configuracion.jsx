          ...
          <div style={{ maxWidth: 600 }}>
            ...
            <div className="alert alert-warning">
              ...
              <div>
                ...
                <strong> Efectivo</strong>, <strong>QR</strong>, <strong>Débito</strong> o <strong>Delivery</strong>.
                <br /><br />
                Si selecciona <strong>Delivery</strong>, el recargo configurado aquí se aplicará automáticamente
                sobre el subtotal de los productos. El recargo se almacena como <em>snapshot</em> en la venta,
