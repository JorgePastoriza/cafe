...
export default function Ventas() {
  ...
  const deliveryCount = sales.filter(s => s.payment_method === 'delivery').length;
        ...
        {!loading && sales.length > 0 && (
          <div className="stat-grid mb-4">
            ...
            <div className="stat-card">
              ...
              <div className="stat-value">{formatPrice(totalByPayment.delivery || 0)}</div>
            </div>
            {deliveryCount > 0 && (
              <div className="stat-card" style={{ borderColor: 'var(--warning)' }}>
                ...
                <div className="stat-value" style={{ color: 'var(--accent-dark)' }}>
                  {formatPrice(totalSurcharge)}
                </div>
                <div style={{ fontSize: 11, color: 'var(--text-muted)', marginTop: 2 }}>
                  {deliveryCount} ventas delivery
                </div>
              </div>
            )}
          </div>
